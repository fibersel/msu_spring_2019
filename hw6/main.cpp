...
int main(int argc, char * argv[]) {
    ...
    data_accessor  accessor_1(batch_size);
    data_accessor  accessor_2(batch_size);
    std::string threadname_1 = "first";
    std::string threadname_2 = "second";
    std::thread worker_1(sorter, threadname_1, std::ref(accessor_1), 0);
    std::thread worker_2(sorter, threadname_2, std::ref(accessor_2), 1);
